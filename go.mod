module github.com/XiaoDouGeGe/sample-scheduler
...
replace (
	...
	k8s.io/controller-manager => k8s.io/controller-manager v0.17.4
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.17.4
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.17.4
